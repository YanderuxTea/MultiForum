...
export default function ContentMenuAvatarManagement({
  setUsers,
  users,
  pending,
  setPending,
  ...
  return (
    <div className="flex flex-col gap-5 items-center">
      <p className="mt-2.5 font-bold text-lg text-center">
      ...
      <div className="flex flex-col gap-2.5 items-center w-full">
        ...
        />
        <AvatarUser
          props={{ avatar: avatar, role: role, width: 128, height: 128 }}
        />
        <CheckNameplateUser role={role} />
      </div>
      <button
        onClick={!pending ? () => deleteAvatar() : undefined}
        disabled={pending}
        className="font-medium text-white bg-red-600 dark:bg-red-700 transition-colors duration-300 ease-out hover:bg-red-500 dark:hover:bg-red-600 active:bg-red-700 dark:active:bg-red-800 w-full rounded-md py-1.25 cursor-pointer disabled:cursor-default disabled:bg-neutral-300 dark:disabled:bg-neutral-700"
      >
