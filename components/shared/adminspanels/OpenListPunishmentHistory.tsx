...
export default function OpenListPunishmentHistory() {
  ...
  return <motion.div key='historyList' initial={{height:0}} animate={{height:'auto'}} exit={{height:0}} className='overflow-clip flex flex-col gap-2.5'>
    ...
    <AnimatePresence>
      {openBans&&<motion.div key='bans' initial={{height:0, overflowY:'clip', paddingBottom:0, paddingTop:0}} animate={{height:200, overflowY:'auto', paddingBottom:10, paddingTop:10}} exit={{height:0, overflowY:'clip', paddingBottom:0, paddingTop:0}}
                             className={`flex gap-2.5 flex-col h-50 border bg-neutral-100 border-neutral-300 dark:border-neutral-700 dark:bg-neutral-900 rounded-md ${bans.length === 0 && 'justify-center items-center'}`}>
    ...
    <AnimatePresence>
      {openWarns&&<motion.div key='warns' initial={{height:0, overflowY:'clip', paddingBottom:0, paddingTop:0}} animate={{height:200, overflowY:'auto', paddingBottom:10, paddingTop:10}} exit={{height:0, overflowY:'clip', paddingBottom:0, paddingTop:0}}
                              className={`flex-col gap-2.5 h-50 flex border bg-neutral-100 border-neutral-300 dark:border-neutral-700 dark:bg-neutral-900 rounded-md ${warns.length === 0 && 'justify-center items-center'}`}>
