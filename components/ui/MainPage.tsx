...
import CategoriesMain from "@/components/shared/categories/CategoriesMain.tsx";
...
export default function MainPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col gap-2.5 w-full px-2.5 items-center">
