...
export default function Footer() {
  ...
  return (
    <footer className="bg-white dark:bg-[#212121] w-full flex items-center justify-center px-2.5 z-1 border-t border-neutral-300 dark:border-neutral-700">
      <div className="max-w-300 w-full py-2.5 flex flex-row justify-between items-center">
        <div className="flex flex-col gap-2.5">
          <p className="text-neutral-700 dark:text-neutral-200 text-lg font-bold">
            Контакты
          </p>
