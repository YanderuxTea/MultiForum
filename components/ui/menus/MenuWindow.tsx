...
export default function MenuWindow({props}:{props:IProps}) {
  ...
  return <motion.div initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}} className='bg-black/25 backdrop-blur-xs fixed inset-0 z-100 flex items-center justify-center p-2.5' ref={containerRef}>
