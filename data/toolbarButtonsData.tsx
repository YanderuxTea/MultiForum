...
export const toolbarButtonsData: IToolbarButtonsData[] = [
  ...
  },
  {
    type: "linkButton",
    icon: <LinkIcon />,
    menuContent: (editor, setIsOpenMenu) => (
      <LinkContent editor={editor} setIsOpenMenu={setIsOpenMenu} />
    ),
  },
  {
    type: "imageButton",
    icon: <ImageIcon />,
    menuContent: (editor, setIsOpenMenu) => (
      <ImageContent editor={editor} setIsOpenMenu={setIsOpenMenu} />
    ),
  },
  {
    type: "videoButton",
    icon: <YouTubeIcon />,
    menuContent: (editor, setIsOpenMenu) => (
      <VideoContent editor={editor} setIsOpenMenu={setIsOpenMenu} />
    ),
  },
  {
    type: "previewButton",
  ...
  {
    type: "alignLeftButton",
    icon: <AlignLeft />,
    mark: "left",
    command: (editor) => editor?.chain().toggleTextAlign("left").run(),
  },
  {
    type: "alignCenterButton",
    icon: <AlignCenter />,
    mark: "center",
